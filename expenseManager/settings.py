...
SECRET_KEY = 'django-insecure-e5m)6!($=r4*jgjp+s@i3f8n(cbtgsgg85n-x=z3r!&&a_64u2'
...
INSTALLED_APPS = [
    'crispy_forms',
    'incomeSummary.apps.IncomesummaryConfig',
    'expenseSummary.apps.ExpensesummaryConfig',
